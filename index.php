            ...
            <div class="row text-center">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="media/png.png" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="media/jpeg.jpg" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top" src="media/gif.gif" alt="..." />
                        <div class="card-body">
                ...
                <div id="muzik-space">
                    <audio controls autoplay>
                        <source src="media/mp3.mp3" style="color: white;" id="audio-1">
                    Audio File
                    </audio>
                </div>
            </div>
